var options = {
    series: [
      { name: "Task completed", data: [44, 55, 41, 37, 44] },
      { name: "Presence", data: [53, 32, 33, 52, 22] },
      { name: "Completed Meeting", data: [12, 24, 22, 23, 35] },
    ],
    chart: {
      type: "bar",
      height: 355,
    ...
    plotOptions: {
      bar: {
        horizontal: !0,
        barHeight: "50%",
        dataLabels: { show: !1, total: { enabled: !1 } },
      },
    },
    ...
    fill: { opacity: 1 },
    legend: { position: "bottom", horizontalAlign: "center", show: !0 },
    grid: {
  ...
  chart = new ApexCharts(
    document.querySelector("#employeeRating-chart"),
    options,
  ),
  options =
    (chart.render(),
    {
      ...
      plotOptions: {
        bar: {
          ...
          columnWidth: "60%",
          dataLabels: {
            total: { style: { fontSize: "13px", fontWeight: 900 } },
          },
        },
      },
      ...
      colors: [
        "rgba(113, 104, 238, 0.8)",
        "rgba(113, 104, 238, 0.5)",
        "rgba(113, 104, 238, 0.2)",
      ],
      legend: { position: "top", show: !0, horizontalAlign: "right" },
      fill: { opacity: 1 },
      grid: {
        padding: { top: -20, right: 0, bottom: 0 },
        strokeDashArray: 4,
      ...
      series: [
        {
          ...
          data: [
            ...
            20, 2, 22, 21, 25, 30, 24, 27, 32, 28, 35, 31, 26, 40, 29, 33, 37,
            34, 39,
          ],
        },
        {
  ...
  options =
    ((chart = new ApexCharts(
      document.querySelector("#chart-traffic"),
      options,
    )).render(),
    {
      chart: {
      ...
      fill: {
        ...
        gradient: {
          shadeIntensity: 0.5,
          gradientToColors: ["#7168EE", "#fa709a"],
          inverseColors: !1,
          opacityFrom: 0.9,
          opacityTo: 0.4,
          stops: [0, 90, 100],
  ...
  options =
    ((chart = new ApexCharts(
      document.querySelector("#chart-development-activity"),
      options,
    )).render(),
    {
      series: [
  ...
  options =
    ((chart = new ApexCharts(
      document.querySelector("#chart-new-clients"),
      options,
    )).render(),
    {
      series: [
        { name: "Website Visitor", data: [44, 55, 57, 56, 61, 58, 63, 60, 66] },
      ],
      chart: {
        height: 352,
        type: "bar",
      ...
      dataLabels: { enabled: !1 },
      colors: ["#f59440"],
      stroke: { curve: "smooth", lineCap: "round", width: "1", dashArray: 0 },
      xaxis: {
        categories: [
          "Feb",
          "Mar",
  ...
  options =
    ...
    )).render(),
    {
      ...
      chart: { height: 313, type: "radialBar" },
      dataLabels: { enabled: !1 },
      legend: { show: !1 },
      stroke: {
        show: !0,
      ...
      plotOptions: {
        radialBar: {
          dataLabels: {
            ...
            value: { color: "#111", fontSize: "14px", offsetY: 2, show: !0 },
            total: {
              show: !0,
              label: "Total",
              color: "var(--text-muted)",
  ...
  options =
    (chartorders.render(),
    {
      series: [
        {
          name: "Revenue chart",
          data: [
            12500, 8e3, 7800, 9e3, 6200, 6e3, 4700, 4700, 5200, 5e3, 5700, 5500,
            5800, 5500, 6200, 5500, 5500, 2400, 2600, 2e3,
          ],
        },
      ],
      chart: {
      ...
      grid: {
        ...
        strokeDashArray: 4,
        yaxis: { lines: { show: !0 } },
        xaxis: { lines: { strokeDashArray: 0, show: !0 } },
      },
    });
(chart = new ApexCharts(
  document.querySelector("#average-revenue"),
  options,
)).render();
